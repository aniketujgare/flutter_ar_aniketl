...
import 'package:flutter_ar/presentation/worksheet/models/recognition_response.dart';
import 'package:flutter_ar/presentation/worksheet/recognizer/mlkit_text_recognizer.dart';
...
import '../../worksheet/recognizer/interface/text_recognizer.dart';

class FillInTheBlankQLesson extends StatefulWidget {
  const FillInTheBlankQLesson({
    super.key,
  ...
  @override
  State<FillInTheBlankQLesson> createState() => _FillInTheBlankQLessonState();
}

class _FillInTheBlankQLessonState extends State<FillInTheBlankQLesson> {
        ...
        child: Column(
          ...
          children: [
            noOfTextFileds == 1
                ...
                : (DeviceType().isMobile
                    ? 80.verticalSpacer
                    : (screenSize.height * 0.23).verticalSpacer),
